...
function startAttack(){
    ...
    tput civis; pushd cfe > /dev/null 2>&1
...
function guiMode(){
    ...
    whiptail --title "evilTrust - by S4vitar" --msgbox "¡Listo!, la plantilla que se utilizará es la predeterminada en la carpeta cfe" 8 78
